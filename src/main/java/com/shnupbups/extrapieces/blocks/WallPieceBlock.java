...
public class WallPieceBlock extends WallBlock implements PieceBlock {
	...
	@Override
	public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState blockState_2, boolean moved) {
		super.onStateReplaced(state, world, pos, blockState_2, moved);
		if (state.getBlock() != blockState_2.getBlock()) {
			this.getBaseState().onStateReplaced(world, pos, blockState_2, moved);
		}
	}
